      ...
      <div className="relative z-10 container mx-auto px-4 pt-25 pb-20">
        <div className="max-w-6xl mx-auto text-center">
          ...
          {showCompletion ? (
            ...
            <div className="w-full  sm:max-w-2xl mx-auto px-2 mb-8 md:px-0">
  ...
  <div>
    ...
    <p className="text-white/40 text-sm sm:text-lg sm:mb-8 px-4">
      Check Your Email For A Confirmation And Next Steps.
            ...
            <div className="w-full  sm:max-w-2xl mx-auto mb-8 px-2  sm:px-0">
...
`}</style>
            ...
            <div className="w-full sm:max-w-2xl mx-auto  px-2  mb-8">
              {/* Search-style Input */}
              <div className="relative">
