...
const Footer: React.FC = () => {
  return (
    <footer className="relative bg-black text-white px-6 md:py-10  py-6 overflow-hidden">
      {/* Upper Section */}
      <div className="max-w-6xl mx-auto flex flex-col md:flex-row justify-between gap-8 z-10 relative">
        <div>
          <p className="mb-4">
            From Idea to Impact — in 30 Days. We design,<br /> build, and launch AI-first MVPs with fixed <br/> pricing and post-launch support.
          </p>
...
<div className="flex space-x-4 mt-2">
  {/* Facebook */}
  <a href="#" className="w-8 h-8 bg-white rounded-full flex items-center justify-center hover:bg-[#01ACFF]  transition-colors">
    <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20" fill="none">
  <path d="M11.6719 19.3812H8.00315V10.2599H5.50391V7.29015H8.00305V5.17699C8.00305 2.67288 9.10842 0.876953 12.7673 0.876953C13.5411 0.876953 14.756 1.03251 14.756 1.03251V3.79006H13.48C12.1798 3.79006 11.6721 4.18449 11.6721 5.27497V7.29015H14.7073L14.4371 10.2599H11.672L11.6719 19.3812Z" fill="black"/>
</svg>
  </a>
  ...
  <path d="M10.0724 16.6427L6.27602 16.5719C5.04679 16.5472 3.81455 16.5965 2.60948 16.3407C0.776213 15.9586 0.646344 14.0848 0.510435 12.513C0.323181 10.3033 0.395667 8.05346 0.749031 5.86222C0.948365 4.63254 1.73362 3.89904 2.94774 3.81891C7.04617 3.52921 11.1718 3.56312 15.2611 3.69872C15.693 3.71105 16.1279 3.77885 16.5538 3.8559C18.6559 4.23189 18.7072 6.35532 18.8431 8.14283C18.979 9.94883 18.9216 11.7641 18.6619 13.5577C18.4535 15.0432 18.0548 16.2883 16.3726 16.4085C14.2645 16.5657 12.2047 16.692 10.0905 16.652C10.0905 16.6427 10.0785 16.6427 10.0724 16.6427V16.6427ZM7.84049 12.8828C9.42912 11.9521 10.9875 11.0367 12.5671 10.1122C10.9755 9.18144 9.42006 8.26611 7.84049 7.34154V12.8828Z" fill="black"/>
</svg>
  </a>
  ...
  <a href="#" className="w-8 h-8 bg-white rounded-full flex items-center justify-center hover:bg-[#01ACFF] transition-colors">
    <svg xmlns="http://www.w3.org/2000/svg" width="19" height="20" viewBox="0 0 19 20" fill="none">
  <g clip-path="url(#clip0_1134_178)">
    <path d="M18.6733 19.3795V19.3787H18.6779V12.5923C18.6779 9.27229 17.9632 6.71484 14.0819 6.71484C12.2161 6.71484 10.9639 7.73875 10.4528 8.70945H10.3988V7.02479H6.71875V19.3787H10.5507V13.2615C10.5507 11.6509 10.856 10.0934 12.8506 10.0934C14.8159 10.0934 14.8452 11.9315 14.8452 13.3648V19.3795H18.6733Z" fill="black"/>
    <path d="M0.476562 7.02734H4.31311V19.3812H0.476562V7.02734Z" fill="black"/>
    <path d="M2.39393 0.876953C1.16725 0.876953 0.171875 1.87233 0.171875 3.099C0.171875 4.32568 1.16725 5.34187 2.39393 5.34187C3.6206 5.34187 4.61598 4.32568 4.61598 3.099C4.61521 1.87233 3.61983 0.876953 2.39393 0.876953V0.876953Z" fill="black"/>
  </g>
  <defs>
    <clipPath id="clip0_1134_178">
      <rect width="18.5042" height="18.5042" fill="white" transform="translate(0.171875 0.876953)"/>
    </clipPath>
  </defs>
</svg>
  </a>
